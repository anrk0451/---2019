...
namespace White.Action
{
	class RegisterAction
	{
		...
		public static int RegisterEnroll(string rc001, string rc109, string fa001, string rc002, string rc202, string rc003, string rc303, int rc004, int rc404,
			...
			decimal nums, decimal regfee,string source, string handler
			)
		{
			return RegisterEnroll(rc001, rc109, fa001, rc002, rc202, rc003, rc303, rc004, rc404, rc014, rc050, rc051, rc052, rc055, rc099, rc130, price, rc140, rc150, nums, regfee, source,
		...
		public static int RegisterEnroll(string rc001, string rc109, string fa001, string rc002, string rc202, string rc003, string rc303, int rc004, int rc404,
			string rc014, string rc050, string rc051, string rc052, string rc055, string rc099, string rc130, decimal price, DateTime rc140, DateTime rc150,
			decimal nums, decimal regfee, string source, string[] itemId_arry, decimal[] itemPrice_arry, int[] itemNums_arry, string handler
			)
		{
			//逝者编号
			...
			//寄存金额
			OracleParameter op_regfee = new OracleParameter("in_regfee", OracleDbType.Decimal);
			op_regfee.Direction = ParameterDirection.Input;
			op_regfee.Value = regfee;
			...
			if (itemId_arry == null)
				...
				{op_rc001 , op_rc109, op_fa001, op_rc002, op_rc202, op_rc003, op_rc303, op_rc004, op_rc404,
				 ...
				 op_rc150, op_nums,op_regfee,op_source,op_handler});
			else
				return SqlAssist.ExecuteProcedure("pkg_business.prc_Register", new OracleParameter[]
				{op_rc001 , op_rc109, op_fa001, op_rc002, op_rc202, op_rc003, op_rc303, op_rc004, op_rc404,
				 op_rc014, op_rc050,op_rc051,op_rc052, op_rc055,op_rc099, op_rc130, op_price,op_rc140,
				 op_rc150, op_nums,op_regfee,op_source,op_itemId_arry,op_price_arry,op_nums_arry, op_handler});
		}
		...
		/// <param name="handler"></param>
		/// <returns></returns>
		public static int RegisterPay(string rc001, string fa001, decimal price, decimal nums,decimal regfee, string[] itemId_arry, decimal[] itemPrice_arry,
			int[] itemNums_arry,string handler )
		{
			//逝者编号
			OracleParameter op_rc001 = new OracleParameter("ic_rc001", OracleDbType.Varchar2, 10);
			op_rc001.Direction = ParameterDirection.Input;
			...
			if (itemId_arry == null)
				...
				{op_rc001 ,op_fa001,op_price,op_nums,op_regfee, op_handler });
			else
				return SqlAssist.ExecuteProcedure("pkg_business.prc_RegisterPay", new OracleParameter[]
				{op_rc001 ,op_fa001,op_price,op_nums,op_regfee, op_itemId_arry,op_price_arry,op_nums_arry,op_handler });
		}

		public static int RegisterPay(string rc001, string fa001, decimal price, decimal nums, decimal regfee, string handler)
		{
			return RegisterPay(rc001, fa001, price, nums, regfee, null, null, null, handler);
		}
		...
		/// <param name="handler"></param>
		/// <returns></returns>
		public static int RegisterOut(string rc001, string oc003, string oc004, string oc005, int oc030, string fa001, decimal price, decimal nums,decimal fee, string handler)
		{
			//逝者编号
			OracleParameter op_rc001 = new OracleParameter("ic_rc001", OracleDbType.Varchar2, 10);
			op_rc001.Direction = ParameterDirection.Input;
			...
			//补退金额
			OracleParameter op_fee = new OracleParameter("in_fee", OracleDbType.Decimal);
			op_fee.Direction = ParameterDirection.Input;
			op_fee.Value = fee;
			...
			return SqlAssist.ExecuteProcedure("pkg_business.prc_RegisterOut", new OracleParameter[]
				{op_rc001,op_oc003,op_oc004,op_oc005,op_oc030,op_fa001,op_price,op_nums,op_fee,op_handler });
		}
