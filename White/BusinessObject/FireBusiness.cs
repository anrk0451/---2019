...
namespace White.BusinessObject
{
	public partial class FireBusiness : BaseBusiness
	{
		...
		private void barButtonItem10_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
		{
			...
			{
				//权限检查
				if (!AppAction.CheckRight("删除销售项目", gridView1.GetRowCellValue(i, "SA100").ToString())) continue;
		...
		private void SalesEdit(int rowIndex)
		{
			...
			//权限检查
			if (!AppAction.CheckRight("修改销售项目", gridView1.GetRowCellValue(rowIndex, "SA100").ToString())) return;
