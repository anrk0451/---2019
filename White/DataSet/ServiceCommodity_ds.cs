	...
	class ServiceCommodity_ds : System.Data.DataSet
	{
		...
		public ServiceCommodity_ds()
		{
			...
			Si01.Columns.AddRange(new DataColumn[]
				{col_si001,col_si002,col_si003,col_price,col_si005,col_si088,col_si077,col_sortId,col_si099,col_status});
			...
			Gi01.Columns.AddRange(new DataColumn[]
				{col_gi001,col_gi002,col_gi003,col_price2,col_gi088,col_sortId2,col_gi099,col_gi077,col_status_2});
